...
@section('konten')
    <div class="h-full w-full">
        <div class="flex items-center justify-start w-full p-4">
            <h1 class="text-4xl text-gray-950 dark:text-gray-800 font-bold">Tambah Data Menu Makanan</h1>
            <a href="{{ route('menu') }}"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="fid_menu" name="id_menu"
                        ...
                        required value="{{ $data->id_menu }}" readonly />
                </div>
                <div>
                    ...
                    <input type="text" id="nama_menu" name="nama_menu"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Masukkan nama menu" required value="{{ $data->nama_menu }}" />
                </div>
                <div>
                    <label for="harga" class="block mb-2 text-sm font-medium text-gray-950 dark:text-gray-800">Harga</label>
                    <input type="text" id="harga" name="harga"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Masukkan harga" required value="{{ $data->harga }}"/>
                </div>
